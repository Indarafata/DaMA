                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div
                          ...
                          "
                        >
                          <router-link :to="{ name: 'admin.datamahasiswa' }">Jumlah Mahasiswa</router-link>
                        </div>
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div
                          ...
                          "
                        >
                          <router-link :to="{ name: 'admin.datapengaduansarana' }">Pengaduan Sarana</router-link>
                        </div>
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                          {{ pengaduan }}
                        </div>
...
export default {
  meteor: {
    ...
    mahasiswa() {
      return Mahasiswa.find({}).count();
    },
    pengaduan() {
      return Pengaduan.find({}).count();
    }
  },
  computed: {
    ...mapGetters({
